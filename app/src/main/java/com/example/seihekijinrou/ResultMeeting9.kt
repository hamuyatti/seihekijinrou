...
class ResultMeeting9 : AppCompatActivity() {
    ...
    private lateinit var remainmembers8: MutableSet<String?>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.radioGroup.setOnCheckedChangeListener { group, checkedId ->
            when (checkedId) {
                R.id.name1 -> Suspect9 = candidate1.toString()

                R.id.name2 -> Suspect9 = candidate2.toString()

                R.id.name3 -> Suspect9 = candidate3.toString()

                R.id.name4 -> Suspect9 = candidate4.toString()

                R.id.name5 -> Suspect9 = candidate5.toString()

                R.id.name6 -> Suspect9 = candidate6.toString()

                R.id.name7 -> Suspect9 = candidate7.toString()

                R.id.name8 -> Suspect9 = candidate8.toString()

                R.id.name9 -> Suspect9 = candidate9.toString()
