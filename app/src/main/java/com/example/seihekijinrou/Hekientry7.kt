...
import com.example.seihekijinrou.databinding.ActivityHekientry7Binding



class Hekientry7 : AppCompatActivity() {
    private lateinit var binding: ActivityHekientry7Binding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityHekientry7Binding.inflate(layoutInflater)
    ...
    fun onSeihekiUpTapped(view: View?) {
        ...
        var pref = PreferenceManager.getDefaultSharedPreferences(this)
        pref.edit {
            putString("seiheki7", binding.Heki.text.toString())
            putString("name7", binding.Getname.text.toString())
                .apply()
        }
    }
}