...
import com.example.seihekijinrou.databinding.ActivityEnd1ofbadBinding

class End1ofBad : AppCompatActivity() {
    private lateinit var binding:ActivityEnd1ofbadBinding
