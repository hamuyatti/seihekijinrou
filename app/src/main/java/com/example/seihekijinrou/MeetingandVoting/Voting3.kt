...
import com.example.seihekijinrou.databinding.ActivityVoting3Binding


class Voting3 : AppCompatActivity() {
    private lateinit var binding: ActivityVoting3Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityVoting3Binding.inflate(layoutInflater)
