...
import com.example.seihekijinrou.MeetingandVoting.Voting.*
       ...
       var numberofpeople =  pref.getString("numberofpeople","")
        ...
        binding.Meetingstop.setOnClickListener{
            if(numberofpeople=="３人"){
                ...
                var intent = Intent(this, Voting3::class.java)
                ...
                var intent = Intent(this, Voting4::class.java)
                startActivity(intent)
            }
                ...
                var intent = Intent(this, Voting5::class.java)
                startActivity(intent)
            }
                ...
                var intent = Intent(this, Voting6::class.java)
                startActivity(intent)
            }
                ...
                var intent = Intent(this, Voting7::class.java)
                startActivity(intent)
            }
                ...
                var intent = Intent(this, Voting8::class.java)
                startActivity(intent)
            }
                ...
                var intent = Intent(this, Voting9::class.java)
                startActivity(intent)
            }
            else{
                var intent = Intent(this, Voting10::class.java)
                startActivity(intent)
            }
