                ...
                Voting
                        ...
                        .addOnSuccessListener {
                            if(it.contains("投票9")){
                                ...
                                var list= listOf(vote1,vote2,vote3,vote4,vote5,vote6,vote7,vote8,vote9)
                               ...
                               if(list1[0].count==list1[1].count){
                                   ...
                                   var Suspect9 = hashMapOf(
                                           "Suspect9" to list1[0].name,

                                           )
                                   Voting.set(Suspect9, SetOptions.merge())
                                   pref.edit {
                                       putString("ThistimeMeeting", "9")
                                   }.apply {  }
                               }
